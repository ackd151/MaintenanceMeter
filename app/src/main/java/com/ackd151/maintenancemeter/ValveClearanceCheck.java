...
public class ValveClearanceCheck extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_valve_clearance_check);
    ...
    public void checkValveClearance(View v) {
        ...
        profile.resetValveClearance(leftIntakeGap, rightIntakeGap, leftExhaustGap, rightExhaustGap);
